...
sudo cp ./cache/script.sh ~/.
sudo cp ./cache/.xprofile ~/.
sudo mkdir ~/wallpapers
sudo cp ./cache/set.jpg ~/wallpapers/set.jpg
...
sudo cp ./cache/dwm.desktop /usr/share/xsessions/dwm.desktop
sudo chown 644 /usr/share/xsessions/dwm.desktop
sudo cp ./cache/sxhkd.service /etc/systemd/system/sxhkd.service
